        ...
        <div className="w-full md:w-1/2 order-2 md:order-1 mt-12 md:mt-32">
          <div className="space-y-12">
            <h1 className="text-4xl font-bold">
              Hello ! Welcome here to Learning Something{" "}
              <span className="text-pink-500">New Everyday</span>
            </h1>
            <p className="text-xl">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum
              magnam voluptatem nihil nulla, neque veniam deserunt, minima eum
              perferendis cupiditate eveniet amet natus! Enim placeat amet
              impedit necessitatibus doloremque quis.
            </p>
